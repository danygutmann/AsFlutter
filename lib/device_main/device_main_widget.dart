...
export 'device_main_model.dart';

class DeviceMainWidget extends StatefulWidget {
  const DeviceMainWidget({super.key});

  static String routeName = 'DeviceMain';
  static String routePath = '/deviceMain';

  @override
  State<DeviceMainWidget> createState() => _DeviceMainWidgetState();
}

class _DeviceMainWidgetState extends State<DeviceMainWidget> {
  late DeviceMainModel _model;
            ...
            child: Column(
              ...
              children: [
                ...
                if (FFAppState().CurrentDeviceInfo.line06Vissible)
                  Align(
                    ...
                    child: Padding(
                      ...
                      child: FFButtonWidget(
                        onPressed: () async {
                          await _model.editLine06(context);
                        },
                        text: FFAppState().CurrentDeviceInfo.line06Description,
                        options: FFButtonOptions(
                          width: double.infinity,
                          height: 40.0,
                          padding: EdgeInsetsDirectional.fromSTEB(
                ...
                if (FFAppState().CurrentDeviceInfo.line07Vissible)
                  Align(
                    ...
                    child: Padding(
                      ...
                      child: FFButtonWidget(
                        onPressed: () async {
                          await _model.editLine07(context);
                        },
                        text: FFAppState().CurrentDeviceInfo.line07Description,
                        options: FFButtonOptions(
                          width: double.infinity,
                          height: 40.0,
                          padding: EdgeInsetsDirectional.fromSTEB(
                ...
                if (FFAppState().CurrentDeviceInfo.line08Vissible)
                  Align(
                    ...
                    child: Padding(
                      ...
                      child: FFButtonWidget(
                        onPressed: () async {
                          await _model.editLine08(context);
                        },
                        text: FFAppState().CurrentDeviceInfo.line08Description,
                        options: FFButtonOptions(
                          width: double.infinity,
                          height: 40.0,
                          padding: EdgeInsetsDirectional.fromSTEB(
                ...
                if (FFAppState().CurrentDeviceInfo.line09Vissible)
                  Align(
                    ...
                    child: Padding(
                      ...
                      child: FFButtonWidget(
                        onPressed: () async {
                          await _model.editLine09(context);
                        },
                        text: FFAppState().CurrentDeviceInfo.line09Description,
                        options: FFButtonOptions(
                          width: double.infinity,
                          height: 40.0,
                          padding: EdgeInsetsDirectional.fromSTEB(
                ...
                if (FFAppState().CurrentDeviceInfo.line10Vissible)
                  Align(
                    ...
                    child: Padding(
                      ...
                      child: FFButtonWidget(
                        onPressed: () async {
                          await _model.editLine10(context);
                        },
                        text: FFAppState().CurrentDeviceInfo.line10Description,
                        options: FFButtonOptions(
                          width: double.infinity,
                          height: 40.0,
                          padding: EdgeInsetsDirectional.fromSTEB(
                ...
                if (FFAppState().CurrentDeviceInfo.line11Vissible)
                  Align(
                    ...
                    child: Padding(
                      ...
                      child: FFButtonWidget(
                        onPressed: () async {
                          await _model.editLine11(context);
                        },
                        text: FFAppState().CurrentDeviceInfo.line11Description,
                        options: FFButtonOptions(
                          width: double.infinity,
                          height: 40.0,
                          padding: EdgeInsetsDirectional.fromSTEB(
                ...
                if (FFAppState().CurrentDeviceInfo.line12Vissible)
                  Align(
                    ...
                    child: Padding(
                      ...
                      child: FFButtonWidget(
                        onPressed: () async {
                          await _model.editLine12(context);
                        },
                        text: FFAppState().CurrentDeviceInfo.line12Description,
                        options: FFButtonOptions(
                          width: double.infinity,
                          height: 40.0,
                          padding: EdgeInsetsDirectional.fromSTEB(
                ...
                if (FFAppState().CurrentDeviceInfo.line13Vissible)
                  Align(
                    ...
                    child: Padding(
                      ...
                      child: FFButtonWidget(
                        onPressed: () async {
                          await _model.editLine13(context);
                        },
                        text: FFAppState().CurrentDeviceInfo.line13Description,
                        options: FFButtonOptions(
                          width: double.infinity,
                          height: 40.0,
                          padding: EdgeInsetsDirectional.fromSTEB(
                ...
                if (FFAppState().CurrentDeviceInfo.line14Vissible)
                  Align(
                    ...
                    child: Padding(
                      ...
                      child: FFButtonWidget(
                        onPressed: () async {
                          await _model.editLine14(context);
                        },
                        text: FFAppState().CurrentDeviceInfo.line14Description,
                        options: FFButtonOptions(
                          width: double.infinity,
                          height: 40.0,
                          padding: EdgeInsetsDirectional.fromSTEB(
                ...
                Padding(
                  ...
                  child: FFButtonWidget(
                    onPressed: () async {
                      context.pushNamed(DeviceOptionsWidget.routeName);
                    },
                    text: FFLocalizations.of(context).getText(
                      '75u35y99' /* Device Options */,
                    ),
                    options: FFButtonOptions(
                      width: double.infinity,
                      height: 40.0,
                ...
                Padding(
                  ...
                  child: FFButtonWidget(
                    onPressed: () async {
                      context.pushNamed(DeviceSaveToPhoneWidget.routeName);
                    },
                    text: FFLocalizations.of(context).getText(
                      'wsevejrk' /* Save to Phone */,
                    ),
                    options: FFButtonOptions(
                      width: double.infinity,
                      height: 40.0,
                ...
                Padding(
                  ...
                  child: FFButtonWidget(
                    onPressed: () async {
                      context.pushNamed(DeviceSaveFromPhoneWidget.routeName);
                    },
                    text: FFLocalizations.of(context).getText(
                      'zj1d8saq' /* Load from Phone */,
                    ),
                    options: FFButtonOptions(
                      width: double.infinity,
                      height: 40.0,
